Locales['en'] = {
  ...
  ['already_own'] = 'У вас уже есть: ~b~%s~s~',
  ['not_enough_money'] = 'Вы не можете позволить себе эту модификацию!',
  ['purchased'] = 'Вы приобрели модификацию!',
  ['press_custom'] = 'Нажмите ~INPUT_PICKUP~ чтобы ~y~персонализировать~s~.',
  ['level'] = 'Уровень %s',
  ['neon'] = 'Неон',
...
-- Cosmetics
  ...
  ['respray'] = 'Третий слой',
  ['primary'] = 'Первый слой',
  ['secondary'] = 'Второй слой',
  ['pearlescent'] = 'pearlescent',
  -- Misc
  ['headlights'] = 'Фары',
  ['licenseplates'] = 'license Plate',
  ['windowtint'] = 'Оттенок окна',
  ['horns'] = 'horns',
  -- Neon
  ['neons'] = 'neons',
  -- Wheels
