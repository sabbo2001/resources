...
Citizen.CreateThread(function()
  ...
  for k,v in pairs(Config.CartelStations) do
    ...
    local blipHarita = AddBlipForCoord(v.Harita2.Pos.x, v.Harita2.Pos.y, v.Harita2.Pos.z)

    SetBlipSprite (blipHarita, v.Harita2.Sprite)
    SetBlipDisplay(blipHarita, v.Harita2.Display)
    SetBlipScale  (blipHarita, v.Harita2.Scale)
    SetBlipColour (blipHarita, v.Harita2.Colour)
    SetBlipAsShortRange(blipHarita, true)

    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString(_U('map_blip'))
    EndTextCommandSetBlipName(blipHarita)
