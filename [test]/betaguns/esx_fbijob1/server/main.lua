...
TriggerEvent('esx_society:registerSocietyhakan', 'fbi', 'fbi', 'society_fbi', 'society_fbi', 'society_fbi', {type = 'public'})
...
AddEventHandler('esx_fbijob:giveWeapon', function(weapon, ammo)
	...
	if xPlayer.job.name == 'fbi' then
		...
		print(('esx_fbijob: %s attempted to give weapon!'):format(xPlayer.identifier))
	end
end)
