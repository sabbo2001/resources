...
local reward = math.random(22000,50000)-->reward example
--add your "give money to player stuff" here
end)
...
AddEventHandler('Cops', function(x,y,z,zone)--zone is the name of the map zone ex:"Vespucci" 
 --add your cops alert stuff here
end)
