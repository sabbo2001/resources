...
Config.BlipUpdateTime = 9000 --In milliseconds. I used it on 3000. If you want instant update, 50 is more than enough. Even 100 is good. I hope it doesn't kill FPS and the server.
Config.CooldownMinutes = 12
Config.Locale = 'ru'

Config.Zones = {
	VehicleSpawner = {
		Pos   = {x = 759.01, y = -3195.18, z = 5.97},
...
Config.Delivery = {
	...
	Delivery1 = {
		...
		Type  = 1,
		Payment  = math.random(10000,18000),
	...
	Delivery4 = {
		...
		Color = {r = 204, g = 204, b = 0},
		Type  = 1,
		Payment  = math.random(12000,20000),
	...
	Delivery7 = {
		...
		Color = {r = 204, g = 204, b = 0},
		Type  = 1,
		Payment  = math.random(22000,25000),
	...
	Delivery10 = {
		...
		Color = {r = 204, g = 204, b = 0},
		Type  = 1,
		Payment  = math.random(15000,19000),
	...
	Delivery13 = {
		...
		Color = {r = 204, g = 204, b = 0},
		Type  = 1,
		Payment  = math.random(14000,16500),
