...
--из отдельного скрипта взяли
RegisterServerEvent('esx_thief:getSurrenderStatus')
AddEventHandler('esx_thief:getSurrenderStatus', function(event,targetID)
	TriggerClientEvent("esx_thief:getSurrenderStatusPlayer",targetID,event,source)
end)

RegisterServerEvent('esx_thief:sendSurrenderStatus')
AddEventHandler('esx_thief:sendSurrenderStatus', function(event,targetID,handsup)
	TriggerClientEvent(event,targetID,handsup)
end)

RegisterServerEvent('esx_thief:reSendSurrenderStatus')
AddEventHandler('esx_thief:reSendSurrenderStatus', function(event,targetID,handsup)
	TriggerClientEvent(event,targetID,handsup)
end)
