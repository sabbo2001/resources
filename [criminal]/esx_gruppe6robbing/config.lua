...
ru = {
    ...
    spawnNotif = {
        ...
        msg = "~g~Бронированный инкассаторский фургон только что был замечен."
    },

    copsSpawnNotif = {
        contact = "Gruppe6 инкассаторы",
        title = "~r~Перевозка денежных средств",
        msg = "~g~Один из фургонов начинает движение, будьте внимательны."
    },

    rewardnotif = {"Вы получили ~g~"," ~w~$ грязных денег"},
    onMapBlipName_truck = "Инкассаторский фургон",
    copsOnMapBlipName_truck = "Инкассаторский фургон",
    onMapBlipName_money = "Грязные деньги",
    destroyedTruckNotif = "~r~Деньги были уничтожены.",
    cops_notification = "Нападение на инкассаторский фургон! ~y~",
    cops_Collect_money = "~y~Сотрудник полиции спас денежные средства от налетчиков!",
    cops_Veh_plate = {"~r~Инкассаторы","~y~Подозрительный авто  :  ~g~","  ~y~Модель :  ~g~"},
    copsNoClueNofif = "~y~На данный момент нет информации о подозреваемых...",
...
---------------[SPAWN TIMER]---------------------
config.spawnTimer = math.random(120000,860000)
