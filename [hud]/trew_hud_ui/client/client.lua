...
Citizen.CreateThread(function()
	if Config.ui.showVoice == true then
		...
		while true do
			...
			if IsControlJustPressed(1, 21) and IsControlPressed(1, 246) then
