Locales['ru'] = {
    ...
    ['no_outfit']                = 'Theres no uniform to fit you...',
    ...
    ['vault']                    = 'Safe',
    ['open_vault']               = 'Нажмите ~INPUT_CONTEXT~, чтобы получить доступ к сейфу.',
    ...
    -- Misc  
    ['map_blip']                 = 'Ночной клуб',
    ['nightclub']                = 'Ночной клуб',

    -- Phone  
    ['nightclub_phone']            = 'Ночной клуб',
    ['nightclub_customer']         = 'Citizen',
    ['alert_nightclub']         = 'Оповещение',
    -- Teleporters
