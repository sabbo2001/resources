...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, Keys['PAGEDOWN']) and IsInputDisabled(0) and not isDead then
			OpenAnimationsMenu()
		end

		if IsControlJustReleased(0, Keys['BACKSPACE']) and IsInputDisabled(0) and not isDead then
